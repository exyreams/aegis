  ...
  const [complianceItems] = useState<ComplianceItem[]>([
    {
      ...
      responsible: "CFO",
      priority: "high",
      documents: ["financial-statements-q4.pdf", "dscr-calculation.xlsx"],
      notes: "Current DSCR: 1.42x - well above minimum requirement",
    },
    {
      id: "2",
      loanId: "1",
      ...
      description: "Provide monthly financial statements within 30 days",
      frequency: "monthly",
      status: "upcoming",
      dueDate: "2025-01-30",
      ...
      priority: "medium",
      documents: ["dec-2024-financials.pdf"],
    },
    {
      id: "3",
      loanId: "1",
      ...
      description: "Notify lender within 5 days of any material adverse change",
      ...
      priority: "critical",
      documents: [],
      notes: "No material adverse changes to report",
    },
    {
      id: "4",
      loanId: "2",
      ...
      description:
        "Submit annual compliance certificate with audited financials",
      frequency: "annually",
      status: "at_risk",
      dueDate: "2025-03-31",
      nextDue: "2025-03-31",
      ...
      priority: "high",
      documents: ["draft-compliance-cert.pdf"],
      notes: "Audit in progress, may need extension",
    },
    {
      id: "5",
      loanId: "3",
      ...
      description: "Maintain minimum tangible net worth of $10M",
      frequency: "quarterly",
      status: "overdue",
      dueDate: "2024-12-31",
      lastCompleted: "2024-09-30",
      nextDue: "2024-12-31",
      responsible: "CFO",
      priority: "critical",
      documents: [],
      notes: "Current net worth: $8.5M - breach of covenant",
    },
  ]);
