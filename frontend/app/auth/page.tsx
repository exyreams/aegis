        ...
        <div className="flex flex-col gap-4 p-6 md:p-10 relative overflow-hidden">
          ...
          >
            ...
            >
              ...
              <span className="font-bold text-foreground">Aegis RFQ</span>
            </Link>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-center h-full p-8">
            <div className="text-center max-w-md">
              ...
              >
                {mode === "login" ? "Welcome Back" : "Join Aegis RFQ"}
              </motion.h2>
              ...
              >
                {mode === "login"
                  ? "Access your institutional lending platform with privacy-preserving smart contracts on Canton Network."
                  : "Start your institutional lending journey. Connect with lenders through secure, confidential smart contracts."}
              </motion.p>
            </div>
          </div>
        </motion.div>
