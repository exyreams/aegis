    ...
    <section className="py-24 bg-background text-foreground relative overflow-hidden border-t border-border">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold mb-6 tracking-tight">
          Initialize Your <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">Institutional Node</span>
        </h2>
        
        <p className="text-xl text-muted-foreground mb-10 leading-relaxed max-w-2xl mx-auto">
          Join the network of 150+ financial institutions running Aegis RFQ. 
          Deploy your node in minutes or access via our managed API gateway.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Button variant="outline" className="h-14 px-8 border-border text-muted-foreground hover:bg-muted hover:text-foreground rounded-none font-mono uppercase tracking-wide text-lg">
