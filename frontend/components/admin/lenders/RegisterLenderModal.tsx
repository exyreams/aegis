...
import { AlertCircle, X, CheckCircle, Loader2, UserPlus } from "lucide-react";
...
interface RegisterLenderModalProps {
  open: boolean;
...
export function RegisterLenderModal({
  open,
  onOpenChange,
  platform,
  onSuccess,
}: RegisterLenderModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const result = await aegisApi.registerLender(platform.contractId, {
        newLender: lenderParty,
      ...
      const errorMsg =
        error instanceof Error ? error.message : "Failed to register lender";
      setError(errorMsg);
  ...
  return (
    <WideModal open={open} onOpenChange={handleClose}>
      <WideModalContent className="overflow-hidden" showCloseButton={false}>
        <WideModalTitle className="sr-only">Register New Lender</WideModalTitle>
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              >
                ...
                <AlertDescription className="text-blue-800 dark:text-blue-300">
                  ...
                  <p className="text-xs">
                    Register a lender on the platform with an initial asset
                    type. This will create their first asset balance record.
                  </p>
                </AlertDescription>
              </Alert>
            </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Select the user account to register as a lender
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Initial asset type for this lender
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      Asset symbol or identifier (e.g., USD, BTC, USDC)
                    </p>
                  </div>
                </div>
