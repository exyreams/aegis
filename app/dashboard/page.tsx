              ...
              <div className="relative p-8 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                  ...
                  <p className="text-slate-400 text-sm max-w-md">
                    Welcome, {user?.name}. Your institutional loan portfolio and
                    compliance workspace is synchronized.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="border-white/10 bg-white/5 hover:bg-white/10 text-white h-11 px-6 backdrop-blur-sm gap-2 group"
                    >
                  ...
                  <Link href="/dashboard/secondary-market">
                    <Button
                      variant="outline"
                      className="border-white/20 bg-white/10 hover:bg-white/20 text-white h-11 px-6 backdrop-blur-sm gap-2"
                    >
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center gap-2 mt-4 text-[10px] font-medium">
                      <span className="text-blue-500">
                        {listings?.length || 0} monitored assets
                      </span>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center gap-2 mt-4 text-[10px] font-medium">
                      <span className="text-muted-foreground">
                        Comprehensive coverage for 100% of holdings
                      </span>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardHeader className="flex flex-row items-center justify-between border-b py-4">
                    <div className="space-y-0.5">
                      ...
                      <CardDescription className="text-xs">
                        Your latest compliance and due diligence reports
                      </CardDescription>
                    </div>
                    <Link href="/dashboard/secondary-market/due-diligence">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 text-xs gap-1.5 px-3 hover:bg-zinc-100 dark:hover:bg-zinc-800"
                      >
                        View Full Workspace{" "}
                          ...
                          <div className="flex items-center gap-4">
                            <div
                              className={cn(
                                ...
                                audit.dueDiligenceScore >= 85
                                  ? "bg-emerald-50 border-emerald-100 dark:bg-emerald-500/5 dark:border-emerald-500/20"
                                  : "bg-blue-50 border-blue-100 dark:bg-blue-500/5 dark:border-blue-500/20"
                              )}
                            >
                              <ShieldCheck
                                className={cn(
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <span className="text-[10px] text-muted-foreground font-mono">
                                  {formatCurrency(audit.loanAmount || 0)}
                                </span>
                              </div>
                            </div>
                          </div>
                    ...
                    {(!privateAudits || privateAudits.length === 0) && (
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-sm font-medium text-muted-foreground">
                          No custom audits found
                        </p>
                        <p className="text-xs text-zinc-400 max-w-[200px] mt-1">
                          Upload an LMA document to start your first private
                          audit.
                        </p>
                      </div>
                    )}
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="pt-4 mt-4 border-t border-white/5 flex items-center justify-between">
                        <div className="text-xs text-slate-400">
                          Next settlement cycle ends in 14h 22m
                        </div>
                  ...
                  <Card className="border shadow-sm dark:bg-zinc-900/50">
                    ...
                    <CardContent className="space-y-2">
                      <Button
                        ...
                        onClick={() =>
                          toast.info("VDR encrypted connection active", {
                            description:
                              "Legal root access restricted to Deal Lead.",
                          })
                        }
                      >
                      ...
                      <Button
                        ...
                        className="w-full justify-between h-10 group bg-zinc-50 dark:bg-zinc-800/50 hover:border-primary transition-all"
                        onClick={() =>
                          toast.info("Settlement Gateway Online", {
                            description:
                              "Connecting to SWIFT trans-border rail...",
                          })
                        }
                      >
                        <div className="flex items-center gap-2">
